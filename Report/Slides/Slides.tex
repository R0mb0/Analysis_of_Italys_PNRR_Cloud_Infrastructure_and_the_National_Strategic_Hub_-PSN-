...
\begin{document}
	...
	\begin{frame}{Introduzione}
		...
		\vspace{2mm}
		\begin{center}
			\zoombox{\includegraphics[scale=0.17]{1.png}}
		\end{center}
	\end{frame}
	...
	\begin{frame}{Transizione: prima vs dopo}
		...
		\vspace{2mm}
		\begin{center}
			\zoombox{\includegraphics[scale=0.15]{2.png}}
		\end{center}
	\end{frame}
		...
		\begin{tabularx}{\linewidth}{XX}
			{
				...
				\vspace*{-1mm}
			  	\begin{center}
			  		\zoombox{\includegraphics[scale=0.2]{9.png}}
			  	\end{center}
			}
		\end{tabularx}
	...
	\begin{frame}{Piano Triennale 2024--2026}
		...
		\vspace*{2mm}
		\begin{center}
			\zoombox{\includegraphics[scale=0.15]{3.png}}
		\end{center}
	\end{frame}
		...
		\begin{tabularx}{\linewidth}{XX}
			{
				\vspace*{-1mm}
				\begin{center}
					\zoombox{\includegraphics[scale=0.2]{4.png}}
				\end{center}
			}&{
				\begin{itemize}
	...
	%================================================
	\begin{frame}{Cloud Italia: perché?}
		\begin{itemize}
		...
		\vspace*{2mm}
		\begin{center}
			\zoombox{\includegraphics[scale=0.3]{5.png}}
		\end{center}
	\end{frame}
		...
		\begin{tabularx}{\linewidth}{XX}
			{
				...
				\vspace*{-1mm}
				\begin{center}
					\zoombox{\includegraphics[scale=0.2]{6.png}}
				\end{center}
			}
		\end{tabularx}
		...
		\begin{tabularx}{\linewidth}{XX}
			{
				...
				\vspace*{-1mm}
				\begin{center}
					\zoombox{\includegraphics[scale=0.2]{7.png}}
				\end{center}
		...
		\begin{tabularx}{\linewidth}{XX}
			{
				...
				\vspace*{-1mm}
				\begin{center}
					\zoombox{\includegraphics[scale=0.23]{8.png}}
				\end{center}
			}
		\end{tabularx}
	...
	\begin{frame}{Sicurezza: da tecnologia a governance}
		...
		\vspace{2mm}
		\begin{center}
			\zoombox{\includegraphics[scale=0.25]{10.png}}
		\end{center}
	\end{frame}
	...
	%================================================
	\begin{frame}{In che senso è ``più centralizzato'' ma resta ``distribuito''?}
		\begin{tabularx}{\linewidth}{XX}
			{
				\begin{center}
					\textbf{\large È centralizzato perché: }
				\end{center}
				\begin{itemize}
				...
				\begin{center}
					\textbf{\large È distribuito perché:}
				\end{center}
				\begin{itemize}
	...
	\section{Rischi}
	%================================================
	\begin{frame}{I rischi}
		\begin{tabularx}{\linewidth}{XXX}
			{
				\begin{center}
					\textbf{\large Il rischio tecnico}
				\end{center}
				\begin{itemize}
				...
				\begin{center}
					\textbf{\large La dipendenza operativa}
				\end{center}
				\begin{itemize}
		...
		\begin{tabularx}{\linewidth}{XX}
			{
				\vspace*{-1mm}
				\begin{center}
					\zoombox{\includegraphics[scale=0.25]{11.png}}
				\end{center}
			}&{
				\begin{center}
					\Large
